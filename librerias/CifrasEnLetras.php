...
class CifrasEnLetras {
  ...
  public static $listaUnidades = array( // Letras de los números entre el 0 y el 29
    "CERO", "UN", "DOS", "TRES", "CUATRO", "CINCO", "SÉIS", "SIETE", "OCHO", "NUEVE",
    "DIEZ", "ONCE", "DOCE", "TRECE", "CATORCE", "QUINCE", "DIECISÉIS", "DIECISIETE", "DIECIOOCHO", "DIECINUEVE",
    "VEINTE", "VEINTIÚN", "VEINTIDÓS", "VEINTITRÉS", "VEINTICUATRO", "VEINTICINCO", "VEINTISEÍS", "VEINTISIETE", "VEINTIOCHO", "VEINTINUEVE"
  );
