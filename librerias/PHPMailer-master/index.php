...
//     //Recipients
//     $mail->setFrom('soporte@convivefinanciera.com', 'Credito VentAcero');
//     $mail->addAddress('soporte@convivefinanciera.com');     //Add a recipient
...
//     $mail->Body    = 'Este es tu codigo de verificación';
